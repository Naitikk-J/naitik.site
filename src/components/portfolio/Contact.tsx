...
const ContactCard = ({
    ...
    return (
        <a
            ...
            data-cursor
            className="tilt-card group flex items-center justify-center gap-4 rounded-xl border border-border/60 bg-card/20 px-15 py-6 backdrop-blur-sm transition-colors duration-300 hover:border-border hover:bg-card/60"
        >
            <Icon
                size={18}
